...
export const rawrigidbodyset_rbTranslationInto: (a: number, b: number, c: number) => void;
export const rawrigidbodyset_rbRotation: (a: number, b: number) => number;
export const rawrigidbodyset_rbRotationInto: (a: number, b: number, c: number, d: number, e: number) => void;
