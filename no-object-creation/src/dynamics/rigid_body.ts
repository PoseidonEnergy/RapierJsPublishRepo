...
export class RigidBody {
     ...
     *
     * @param {Float32Array} arr - The array to be populated with the translation.
     */
    public translationInto(arr: Float32Array) {
        this.rawSet.rbTranslationInto(this.handle, arr);
    }
