...
export class RawRigidBodySet {
    ...
    /**
     * Populate a provided array with the world-space translation of this rigid-body.
     *
     * # Parameters
     * - `arr`: The array to be populated with the translation.
     * @param {number} handle
     * @param {Float32Array} arr
     */
    rbTranslationInto(handle, arr) {
        try {
            wasm.rawrigidbodyset_rbTranslationInto(this.__wbg_ptr, handle, addBorrowedObject(arr));
        } finally {
            heap[stack_pointer++] = undefined;
        }
    }
    ...
    /**
     * Populate a provided array with the world-space orientation of this rigid-body.
     *
     * # Parameters
     * - `arr`: The array to be populated with the orientation.
     * @param {number} handle
     * @param {Float32Array} arr
     */
    rbRotationInto(handle, arr) {
        var ptr0 = passArrayF32ToWasm0(arr, wasm.__wbindgen_export_2);
        var len0 = WASM_VECTOR_LEN;
        wasm.rawrigidbodyset_rbRotationInto(this.__wbg_ptr, handle, ptr0, len0, addHeapObject(arr));
    }
    /**
...
export function __wbg_setindex_4e73afdcd9bb95cd(arg0, arg1, arg2) {
